                    ...
                    <ul>
                        <li className="nav-item">
                            <Link to="/" className={`nav-link ${isActive('/')}`}>
                                {/* Icons can be componentized further, keeping raw SVG for brevity */}
                        ...
                        <li className="nav-item">
                            <Link to="/analytics" className={`nav-link ${isActive('/analytics')}`}>
                                <svg className="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M12 2L2 7l10 5 10-5-10-5z" /><path d="M2 17l10 5 10-5" /><path d="M2 12l10 5 10-5" /></svg>
                                Analytics
                            </Link>
                        </li>
                        <li className="nav-item">
