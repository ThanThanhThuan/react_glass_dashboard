    ...
    return (
        <div className="login-card">
            <div className="login-header">
                ...
                <p className="login-subtitle">Start your journey with GlassDash</p>
            </div>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="form-row" style={{ marginBottom: '24px' }}>
                    <label className="checkbox-label">
                        ...
                        <span style={{ marginLeft: '10px' }}>I agree to the <Link to="#" style={{ color: 'var(--emerald-light)' }}>Terms & Conditions</Link></span>
                    </label>
                </div>
            ...
            <div className="social-login">
                ...
                <button className="social-btn" title="Sign up with GitHub">
                    <svg viewBox="0 0 24 24" fill="currentColor">
